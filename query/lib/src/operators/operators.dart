...
Cond<ValType> gtEq<ValType>(String field, ValType rhs, {String tableName}) =>
    new Cond<ValType>(
        new Field<ValType>.inTable(tableName, field), Op.GtEq, rhs);
