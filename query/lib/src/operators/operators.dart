...
Cond<ValType> gtEq<ValType>(String field, ValType rhs, [String tableAlias]) =>
    new Cond<ValType>(new Col<ValType>(field, tableAlias), Op.GtEq, rhs);
